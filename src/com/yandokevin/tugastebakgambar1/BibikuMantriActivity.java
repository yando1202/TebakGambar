...
public class BibikuMantriActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bibiku_mantri);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BIBIKU MANTRI";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), BandarTekorActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bibiku_mantri, menu);
		return true;
	}

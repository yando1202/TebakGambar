...
public class BungaSakuraActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bunga_sakura);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BUNGA SAKURA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), BibikuMantriActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bunga_sakura, menu);
		return true;
	}

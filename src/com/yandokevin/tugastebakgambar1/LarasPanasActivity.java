...
public class LarasPanasActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_laras_panas);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "LARAS PANAS";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), DarahTinggiActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.laras_panas, menu);
		return true;
	}

...
public class LurusHatiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lurus_hati);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "LURUS HATI";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), LarasPanasActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lurus_hati, menu);
		return true;
	}

...
public class MalamKelabuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_malam_kelabu);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "MALAM KELABU";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), LurusHatiActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.malam_kelabu, menu);
		return true;
	}

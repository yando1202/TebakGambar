...
public class MotivasiKataActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_motivasi_kata);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "MOTIVASI KATA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), MalamKelabuActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.motivasi_kata, menu);
		return true;
	}

...
public class PolisiNakalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_polisi_nakal);
    	//cari edit text
	...
	public void cekJawaban(View v){
		String jawabanBenar = "POLISI NAKAL";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), MotivasiKataActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.polisi_nakal, menu);
		return true;
	}
